...
try{
    ...
    $cons = "INSERT INTO otros (serial, oficina, asignado, no_acta, detalle) VALUES ('$serial', '$oficina', '$asignado', '$no_de_acta', '$detalle')";
    $res = $con->query($cons);
    ...
    header("Location: ./Public/main/error.php?msg=$error");
}
