<link rel="stylesheet" href="./recursos/tablas.css">
        <div class="contentframe">
                <h1>Consulta por Serial</h1>
                <form action="" method="POST" autocomplete="off">
                    <div class="ingresar">
                        <input type="text" name="entrada" placeholder="S/N 555555555">
                    ...
                    <?php
                        ...
                        try {
                            ...
                            if (!is_int($cedula)) {
                                $consultaPK = "SELECT * FROM usuarios WHERE nombre='$cedula' OR correo='$cedula'";
                                $resp = $con->query($consultaPK);
                            
                                if ($resp->num_rows > 0) {
                                    while ($rowPK = $resp->fetch_assoc()) {
                                        $resPK = $rowPK['cedula'];
                                        $cedula = $resPK; // Asignamos la cédula encontrada
                                    }
                                }
                            }
                                 
             
                            $consulta = "select * from equipos where serial='$cedula'";
                            $consulta2 = "select * from Muebles_y_Enseres where serial='$cedula'";
                            $consulta3 = "select * from otros where serial='$cedula'";
